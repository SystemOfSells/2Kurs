...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        AppendMenu(hMenuBackgroundImg, MF_BITMAP, IDM_Background_Img1, (LPWSTR)hBm1);
        AppendMenu(hMenuBackgroundImg, MF_ENABLED | MF_POPUP | MF_BITMAP, IDM_Background_Img2, (LPWSTR)hBm2);
